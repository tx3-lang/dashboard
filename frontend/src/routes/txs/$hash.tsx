...
const jsonStyles: Partial<typeof darkStyles> = {
	...
	collapseIcon:
		"mr-1.5 inline-block w-4 select-none text-base font-bold leading-none text-primary before:content-['▾']",
	expandIcon: "mr-1.5 inline-block w-4 select-none text-base font-bold leading-none text-primary before:content-['▸']",
